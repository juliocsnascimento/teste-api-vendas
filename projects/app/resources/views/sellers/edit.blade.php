...
<div class="container-xxl">
    ...
    <div>
        ...
        <form method="post" action="{{ route('sellers.edit') }}">
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-2">
                    <input type="number" step="0.5" class="form-control" id="sales_commission" name="sales_commission" value="{{$response->data->sales_commission  ?? ''}}" required>
                </div>
            </div>
